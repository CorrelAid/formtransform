<!-- GENERATED by codegen — DO NOT EDIT BY HAND.
     Edit `registry/entities/integer/definition.jsonld` and re-run `uv run codegen`. -->

# Integer (`integer`)

## Use when

When collecting open integer values without predefined categories, where respondents provide a raw number (e.g. age, household size).
