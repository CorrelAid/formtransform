<!-- GENERATED by codegen — DO NOT EDIT BY HAND.
     Edit `registry/entities/decimal/definition.jsonld` and re-run `uv run codegen`. -->

# Decimal/Float (`decimal`)

## Use when

When collecting open decimal numeric values without predefined categories (e.g. height in metres, temperature).

## Cross-format mapping

| Format | Value |
|--------|-------|
| XLSForm typeString | `decimal` |
...
```mermaid
graph LR
    XLS["XLSForm row<br/>type: decimal"]
