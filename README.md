...
```bash
npm install https://github.com/CorrelAid/formtransform/releases/download/v0.1.5/correlaid-formtransform-0.1.5.tgz
```
...
```bash
npm install github:CorrelAid/formtransform#v0.1.5
```
